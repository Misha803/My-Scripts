...
## ⚖️ License
This project is licensed under custom terms to protect the software while supporting the WOA community. See the [`LICENSE`](LICENSE) file for full details on usage, redistribution, and liability.

---

## 📩 Contact
If you have any questions or want to reach out:
- 📢 Official Channel: [`WOA Tools Official`](https://t.me/woatools)
- 💬 Community Chat: [`Official Chat`](https://t.me/woatools_chat)
- 👤 Developer: [`Contact me on Telegram`](https://t.me/Misha_803)
